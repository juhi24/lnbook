...
hash-based message authentication code (HMAC)::
    An HMAC is a message authentication code method for verifying the integrity and authenticity of a message based on a hash function and a shared secret. It is used in onion routing to ensure the integrity of a packet at each hop.
